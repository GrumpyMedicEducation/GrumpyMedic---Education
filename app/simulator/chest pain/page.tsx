...
export default function ChestPainSimulatorPage() {
  return (
      ...
      <section className="mx-auto max-w-6xl px-6 py-12">
        ...
        <div className="mt-8 rounded-2xl border border-zinc-800 bg-zinc-900 p-8">
          ...
          <p className="mt-3 text-zinc-400">
            Assess possible acute coronary syndrome, obtain a 12-lead ECG,
            administer appropriate treatment, and determine transport priority.
          </p>
        </div>
      </section>
    </main>
