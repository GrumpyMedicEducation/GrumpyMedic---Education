...
export default function TXAAdministrationCertificatePage() {
  ...
  async function loadCertificateInformation() {
    ...
    if (authError) {
      setProfileError(
        "Your account information could not be verified. You may still print the certificate."
      );
    }
    ...
    setProviderLevel(data?.provider_level?.trim() || "");
          ...
          <div className="mx-auto max-w-6xl print:max-w-none">
              ...
              <div className="border-[10px] border-red-700 p-3">
                <div className="border-2 border-black px-8 py-12 text-center md:px-16 md:py-16 print:px-14 print:py-12">
                  ...
                  <p className="mt-3 text-lg font-semibold">
                    Tranexamic Acid for Multisystem Trauma and Obstetrical
                    Emergencies
                  </p>

                  <p className="mt-2 text-base font-semibold text-zinc-600">
                    Massachusetts EMS Protocols • Version 2026.2
                  </p>
                  ...
                  <p className="mx-auto mt-12 max-w-3xl text-xs leading-5 text-zinc-500">
                    ...
                    medication administration or clinical practice, or replace
                    current state and local protocols, Medical Control
                    direction, medication references, service policy, or
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row print:hidden">
              <button
                type="button"
                onClick={printCertificate}
                className="rounded-xl bg-red-600 px-6 py-3 text-center font-bold transition hover:bg-red-500"
              >
                Print / Save Certificate
              </button>
