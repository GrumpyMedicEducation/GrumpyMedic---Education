...
const questions: Question[] = [
  ...
  },
  {
    ...
    options: ["0.5 mg IV once", "1 mg IV/IO", "2 mg IM", "0.02 mg/kg IV"],
    answer: 1,
      ...
      <section className="border-b border-zinc-800 bg-gradient-to-b from-red-950/30 to-black">
        <div className="mx-auto max-w-4xl px-6 py-12">
          ...
          <p className="mt-4 leading-7 text-zinc-300">
            Answer all 25 questions. A score of 80% or higher, which is
            20 correct answers, is required to pass.
          </p>
      ...
      <section className="mx-auto max-w-4xl space-y-8 px-6 py-12">
        {submitted && (
          ...
          >
            ...
            <p className="mt-3 text-xl text-zinc-300">{percentage}%</p>

            <p className="mx-auto mt-4 max-w-2xl leading-7 text-zinc-300">
              {passed
                ? "You met the required passing score. Review the explanations below before returning to the course."
        ...
        {!submitted && (
          <div className="rounded-2xl border border-zinc-700 bg-zinc-900 p-6">
            ...
            <p className="mt-4 text-center text-sm text-zinc-400">
              All 25 questions must be answered before the quiz can be
              submitted.
            </p>
          </div>
        )}
        ...
        <p className="text-center text-sm leading-6 text-zinc-500">
          Educational content only. Verify current Massachusetts
          statewide protocols, local service policies, Medical Control
          direction, medication instructions, and your authorized scope
          of practice.
        </p>
      </section>
    </main>
