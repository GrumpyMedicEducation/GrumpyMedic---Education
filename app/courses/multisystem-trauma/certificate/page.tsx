...
export default function MultisystemTraumaCertificatePage() {
        ...
        <CourseAccessGate>
          <div className="mx-auto max-w-6xl">
            <div className="mb-7 flex flex-wrap items-center justify-between gap-4 print:hidden">
              <Link href="/courses/multisystem-trauma/quiz" className="font-semibold text-red-500 hover:text-red-400">
                ← Back to Quiz
              </Link>
              <button
                type="button"
            ...
            <section className="certificate overflow-hidden rounded-3xl bg-white p-4 text-black shadow-2xl">
              <div className="border-[10px] border-red-800 p-3">
                <div className="border-2 border-black px-8 py-12 text-center md:px-16 md:py-16">
                  ...
                  <h2 className="mx-auto mt-3 max-w-4xl text-3xl font-extrabold text-red-800 md:text-4xl">
                    Multisystem Trauma
                  </h2>
                  <p className="mt-3 text-lg font-semibold">
                    Massachusetts EMS Protocol 4.5 • Adult &amp; Pediatric • Version 2026.2
                  </p>
                  ...
                  <div className="mx-auto mt-14 grid max-w-3xl gap-10 sm:grid-cols-2">
                    <div>
                      <div className="border-b border-black pb-2 text-xl font-semibold">Lt. William Howard, NRP</div>
                      <p className="mt-2 text-sm text-zinc-500">Course Instructor</p>
                    </div>
                    <div>
                      <div className="border-b border-black pb-2 text-xl font-semibold">GrumpyMedic Education</div>
