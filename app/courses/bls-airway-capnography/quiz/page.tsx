...
export default function BLSAirwayCapnographyQuizPage() {
  return (
    ...
    >
      <BLSAirwayCapnographyQuizContent />
    </QuizAccessGate>
  );
}

function BLSAirwayCapnographyQuizContent() {
      ...
      <section className="mx-auto max-w-4xl px-6 py-10">
        ...
        <div className="mt-8">
          ...
          <p className="mt-3 text-zinc-400">
            Answer all 24 questions. The server securely grades and retains the assessment. A score of 80% or higher is required to pass.
          </p>
        </div>
